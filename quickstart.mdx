...
description: "Convert your first PDF to an editable Word document using pdf2wordx. Launch the GUI, open a PDF, pick an output folder, and get a .docx file in minutes."
---
...
<Steps>
  ...
  <Step title="Choose an output directory">
    ...
    The interface updates a second label to show the output filename (your chosen name with the `.docx` extension appended), confirming the name the converted file will be saved as.

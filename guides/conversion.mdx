---
title: "Converting PDFs to Word Documents with pdf2wordx"
...
Once a conversion completes successfully, the `Funcs._disableButton()` method disables both the **"Abrir Archivo"** and **"Convertir"** buttons:
